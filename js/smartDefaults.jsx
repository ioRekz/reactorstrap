...
var defaultProps = function(elem) {
  ...
  return Object.keys(elem.type.propTypes).reduce(function(total, prop) {
    var current = {}
...
var parseDOM = function(elem) {
  ...
  var name = elem.type.displayName
...
var smartDefaults = {
  ...
  smartAll: function(k) {
    /*if(!smartChildren[k]) return {}
    return parseDOM(smartChildren[k])*/
    var elem = Immutable.Sequence(smarties).find(function(e) {
      return e.type.displayName == k
    })
    return elem ? parseDOM(elem) : undefined
  },
